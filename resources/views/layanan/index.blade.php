    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
          <div class="card-header">
            ...
            <a href="{{ route('layanan.index') }}" class="pull-right">
              ...
              <tbody>
               @forelse($data as $layanan)
                <tr>
                  ...
                  <td><img width="120px" src="{{ url('/image/'.$layanan->gambar) }}"></td>
                  <td>
                    <form action="{{ route('layanan.destroy', $layanan->id_layanan) }}" method="POST">
                        <div class="btn-group">
                            <a class="btn btn-sm btn-warning edit_modal color" href="{{ route('layanan.edit', $layanan->id_layanan) }}"><i class="fas fa-pen"></i></a>
                            @csrf
                            @method('DELETE')
